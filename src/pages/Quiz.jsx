                                ...
                                <Form>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <Field name="employeeId" className={`w-full bg-white/10 border rounded-2xl px-4 py-3 ${errors.employeeId && touched.employeeId ? "border-red-500" : "border-white/20"}`} placeholder="เช่น 100001" />
                                            <ErrorMessage name="employeeId" component="div" className="text-red-400 text-sm mt-1" />
                                        </div>

                                        <div>
                                            <label className="block text-sm text-white/70 mb-1">แผนก *</label>
                                            <Select
                                            ...
                                            />
                                            {errors.department && touched.department && <div className="text-red-400 text-sm mt-1">{errors.department}</div>}
                                        </div>

                                        <div className="md:col-span-2">
                                            <label className="block text-sm text-white/70 mb-1">ชื่อ-นามสกุล *</label>
                                            <Field name="fullName" className={`w-full bg-white/10 border rounded-2xl px-4 py-3 ${errors.fullName && touched.fullName ? "border-red-500" : "border-white/20"}`} placeholder="เช่น สมชาย ใจดี" />
